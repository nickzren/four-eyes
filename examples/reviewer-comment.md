...
Reviewer output returns to the human relay or orchestrator. Reviewers never edit coordination metadata. The orchestrator holds carried verdicts until all expected slots return or have terminal records, then posts them verbatim before synthesis.
